...
@section('content')
    <dir class="card">
        ...
        <div class="card-body">
            {!! Form::open(['route' => 'admin.reportage.store','files'=> true ]) !!}
...
@section('js')
    <script>
        ...
        //End cambio de imagen
                ...
                // Almacenar el archivo seleccionado después de enviar el formulario
        window.addEventListener('load', function() {
            var selectedFile = sessionStorage.getItem('selectedFile');
            if (selectedFile) {
                document.getElementById('file').setAttribute('value', selectedFile);
            }
        });
    </script>
@stop
